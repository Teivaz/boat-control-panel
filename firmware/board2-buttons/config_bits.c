...
// CONFIG1
#pragma config FEXTOSC = OFF           // External Oscillator Selection->EC (external clock) above 8 MHz, default ECH
...
#pragma config XINST = OFF     // Extended Instruction Set Enable bit->Extended Instruction Set and Indexed Addressing Mode enabled
